package vortex.data.song.vslice.importer;

import vortex.data.DataError;
/**
...
class ChartManifestData
{
  ...
  @:default(vortex.data.song.vslice.importer.ChartManifestData.CHART_MANIFEST_DATA_VERSION)
  ...
  public function getCombinedDataFileName(?variation: String): String {
    if (variation == null || variation == '') variation = Constants.DEFAULT_VARIATION;

    return '$songId${variation == Constants.DEFAULT_VARIATION ? '' : '-$variation'}.${Constants.EXT_DATA}';
  }
